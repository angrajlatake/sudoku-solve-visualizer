    ...
    <div className="container">
      <div className="header">
        ...
        >
          ...
          <ul className="contact-list">
            <li className="contact-list__item">
              <a
                href="https://github.com/angrajlatake/sudoku-solve-visualizer"
                target="_blank"
                rel="noreferrer"
              >
                <img src={github} alt="github" className="list-img" />
              </a>
            </li>
            <li className="contact-list__item">
              <a
              ...
              >
                <img
                  src={linkedin}
                  alt="linkedIn"
                  className="list-img list-img-svg"
                />
              </a>
            </li>
          </ul>
        ...
        <div className="dev-btn" onClick={props.devMode}>
          {props.dev ? "DEV MODE" : "STANDARD MODE"}
        </div>
      </div>
    </div>
  );
